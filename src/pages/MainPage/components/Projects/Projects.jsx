...
const Projects = () => {
  return (
    <section class=" bg-gray-800 py-12 px-3 ">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <h1 class=" text-3xl font-extrabold text-gray-900 text-white md:text-5xl lg:text-6xl">
        ...
        <ol class="relative border-l border-gray-200 border-gray-700">
          <li class="mb-10 ml-6">
            ...
            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 text-gray-500">
              A third-year college project. | Software Engineering course
              project
            </time>
            <p class="mb-4 text-base font-normal text-gray-500 text-gray-400">
          ...
          <li class="mb-10 ml-6">
            ...
            <p class="text-base font-normal text-gray-500 text-gray-400">
