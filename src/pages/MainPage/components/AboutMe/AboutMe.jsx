      ...
      <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="font-light text-gray-500 sm:text-lg text-gray-400">
          ...
          <a
            ...
            target="_blank"
            class="inline-flex items-center mb-5 justify-center p-3 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 text-gray-400 bg-gray-900 hover:bg-blue-700 hover:text-white"
          >
            <svg
              fill="none"
              stroke="currentColor"
